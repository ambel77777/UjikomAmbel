...
<head>
  ...
  <style>
    .bg-login-image {
      background: url('{{ asset('template/images/logodisdik.png') }}');
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form action="{{ route('login.action') }}" method="POST" class="user">
                    ...
                    <div class="form-group">
                      <input name="password" type="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Masukkan Kata Sandi Anda">
                    </div>
                    <div class="form-group">
